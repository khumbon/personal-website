...
const DesktopNav = ({navSections, currentSection}: DesktopNavProps) => {
  const baseClass =
...
const MobileNav = ({navSections, currentSection}: MobileNavProps) => {
...
const NavItem = ({section, current, inactiveClass, activeClass, onClick}: NavItemProps) => {
  return (
